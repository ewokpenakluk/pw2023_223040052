    ...
    <li class="breadcrumb-item active" aria-current="page">Produk</li>
      ...
      <div class="container">
        <div class="row row-produk">
            <div class="col-lg-5">
            <figure class="figure">
             <img src="./img/celana1.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="450px">
              <figcaption class="figure-caption">
                <a href="kamera.php">
                <img src="./img/Kamera2.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="70px">
                </a>
                <a href="sarungtangan.php">
                <img src="./img/Gloves1.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="70px">
                </a>
              </figcaption>
            </figure>
            </div>
            <div class="col-lg-7">
                ...
                <h3>PANTS RIDE</h3>
                <h4>PANTS sunmory/Riding Semi protecktor</h4>
                <h2>Rp 1.350.000</h2>
