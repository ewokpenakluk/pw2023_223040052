    ...
    <li class="breadcrumb-item active" aria-current="page">Produk</li>
      ...
      <div class="container">
        <div class="row row-produk">
            <div class="col-lg-5">
            <figure class="figure">
             <img src="./img/gloves1.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="450px">
              <figcaption class="figure-caption">
                <a href="sarungtangan2.php">
                <img src="./img/gloves2.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="70px">
                </a>
                <a href="sepatu.php">
                <img src="./img/sepatu2.jpg" class="figure-img img-fluid rounded" style="border-radius: 5px;" width="70px">
                </a>
              </figcaption>
            </figure>
            </div>
            <div class="col-lg-7">
                ...
                <h3>BLACK RED X WHITE</h3>
                <h4>GLOVES FOR RIDE</h4>
                <h2>Rp7.300.000</h2>
